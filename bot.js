...
const comment = async number => {
  await octokit.request({
    ...
    body: 'This comment was generated by my review bot.' // TODO move this to a variable
  });
};



const createReviewComment = rawData => {
//   let comment = 'An auto-generated pull request review!\n\n';
//   const data = organize(rawData);
//   console.log(data);
//   // data.forEach(file => {
//   for (const file in data) {
//     comment += `## ${file}\n\n`;
    
//     for (const issue in data[file]) {
//       comment += `- [ ] ${data[file][issue].description}`;
//       if (data[file][issue].lines) comment += ` Affected lines: ${data[file][issue].lines.join(', ')}`;
//       comment += '\n\n';
//     }
//   }
//   return comment;
...
const audit = async number => {
  ...
  // This PR is not touching any content files. Bail!
  ...
  // Check for the comment from the Netlify bot which indicates that
